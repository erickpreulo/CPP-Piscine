...
/*   Updated: 2022/04/04 23:52:42 by egomes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() {
	std::cout << "Default \" CR7 \" constructor called" << std::endl;
	_name = "CR7";
	_hitPoints = 10;
	_energyPoint = 10;
	_attackDamage = 0;
...
ClapTrap::ClapTrap( std::string name ) {
	std::cout << "Custom name: " << name << " constructor called" << std::endl;
	_name = name;
	_hitPoints = 10;
	_energyPoint = 10;
	_attackDamage = 0;
...
ClapTrap::~ClapTrap() {
	std::cout << "Destructor name: " << _name << " called" << std::endl;
}
